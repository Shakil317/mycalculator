...
class DownloadsPdfScreenState extends StatefulWidget {
  ...
  const DownloadsPdfScreenState({super.key, this.id, this.usersData,this.name});

  @override
  State<DownloadsPdfScreenState> createState() => _DownloadsPdfScreenStateState();
}
                              ...
                              InstaImageViewer(
                                child: CircleAvatar(
                                  ...
                                  backgroundImage: profile.profileImage != null
                                      ...
                                      : const AssetImage("assets/images/shakilansari.jpg") as ImageProvider,
                                ),
                              ),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const Icon(Icons.phone, color: Colors.pink, size: 12),
                        ...
                        child: Table(
                          ...
                          children: [
                            ...
                            ...List.generate(creditProvider.transitionList.length, (index) {
                              ...
                              return TableRow(
                                children: [
                                  Center(child: Text((index + 1).toString(), style: const TextStyle(fontSize: 10))),
                                  Center(child: Text("${data.currentDate}", style: const TextStyle(fontSize: 10))),
                                  Center(child: Text(data.remarkItem ?? "---", style: const TextStyle(fontSize: 10))),
                                  Center(child: Text(data.loanedMoney ?? "--", style: const TextStyle(color: Colors.redAccent, fontSize: 10))),
                                  Center(child: Text(data.receivedMoney ?? "--", style: const TextStyle(color: Colors.green, fontSize: 10))),
                                  Center(child: Text(data.receivedMoney == null ? "---" : data.loanedMoney != null ? "${data.loanedMoney}" : "---", style: const TextStyle(fontSize: 10))),
                                ],
                              );
                            }),
                          ],
                          ...
                          children: [
                                  ...
                                  child: InstaImageViewer(
                                    child: Container(
                                      ...
                                      child: profile.qrImage != null
                                          ...
                                          : const Image(image: AssetImage("assets/images/shakil_upi_scaner.jpg")),
                                    ),
                                  ),
                                ),
                                const Text("Scan QR", style: TextStyle(color: Colors.orangeAccent)),
                              ],
                            ),
                            ...
                            Column(
                              children: [
                                ...
                                const Text("My Stamp", style: TextStyle(color: Colors.orangeAccent)),
                              ],
                            ),
                          ],
                        ),
                      ...
                      const Row(
                        children: [
                          Padding(
                            ...
                            child: Icon(Icons.date_range, color: Colors.green, size: 18),
                          ),
                          SizedBox(width: 5),
                          Text("Generated By UdaanBiz", style: TextStyle(fontSize: 12)),
                          SizedBox(width: 10),
                          CircleAvatar(
                            radius: 10,
